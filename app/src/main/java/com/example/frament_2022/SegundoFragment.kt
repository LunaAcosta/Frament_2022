...
class SegundoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val conector = inflater.inflate(R.layout.fragment_segundo, container, false)


        conector.btnhimn.setOnClickListener {

            val himno = android.media.MediaPlayer.create(context,R.raw.himno_ugb)
            himno.start()
        }
